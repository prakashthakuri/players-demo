...
function About({newDataHandler}) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      await newDataHandler(response.data)
      setLoading(false);
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="Container">
          <div className="subContainer">
            <div className="headingContainer">Basic Info</div>
        ...
        <div className="Container">
          <div className="subContainer">
            <div className="headingContainer">About</div>
            <div className="infoContainer">
            ...
            <div className="buttonContainer">
              <Stack spacing={2} direction="row">
                <Button
                  type="submit"
                  sx={{ width: "320px", marginLeft: "40px" }}
                  size="large"
                  variant="contained"
                >
                  Submit
